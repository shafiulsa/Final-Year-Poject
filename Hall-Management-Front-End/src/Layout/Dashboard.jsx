...
//           upcomingEvents: 3,
//           recentNotices: 5,
//           floorDistribution: [65, 58, 72, 69, 56, 30], // Students per floor
//           departmentDistribution: {
//             labels: ['CSE', 'EEE', 'BBA', 'Arch', 'Pharmacy', 'Other'],
//             data: [120, 85, 60, 35, 30, 20]
//           },
//           monthlyAdmissions: [12, 19, 15, 8, 12, 15, 10, 14, 12, 10, 8, 5]
//         };
...
//           <h1 className="text-2xl font-bold text-blue-800">🏛️ Hall Management</h1>
//         </div>
...
//           {(role === "provost" || role === "housetutor" || role === "staff") && (
//             <>
//               <NavLink
//                 to="/dashboard/swap"
//                 className={({isActive}) =>
...
//               >
//                 <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
//                   <path fillRule="evenodd" d="M8 7a3 3 0 100 6 3 3 0 000-6zM5 10a5 5 0 1110 0 5 5 0 01-10 0z" clipRule="evenodd" />
//                 </svg>
//                 Swap Seat
//               </NavLink>
//               <NavLink
...
//           {(role === "provost" || role === "housetutor" || role === "register") && (
//             <>
//               <NavLink
//                 to="/dashboard/notice"
//                 className={({isActive}) =>
...
//               {isDashboardHome ? 'Dashboard Overview' : location.pathname.split('/').pop().replace('-', ' ')}
//             </span>
//           </div>
...
//               <p className="text-gray-600">Here's what's happening in your hall today.</p>
//             </div>
...
//                     <div>
//                       <Typography variant="h6" className="opacity-75">Total Students</Typography>
...
//                   <div className="flex justify-between items-center">
//                     <div>
//                       <Typography variant="h6" className="opacity-75">Available Seats</Typography>
//                       <Typography variant="h4">{dashboardData.availableSeats}</Typography>
//                     </div>
...
//                   <div className="flex justify-between items-center">
//                     <div>
//                       <Typography variant="h6" className="opacity-75">Upcoming Events</Typography>
//                       <Typography variant="h4">{dashboardData.upcomingEvents}</Typography>
//                     </div>
...
//                   <div className="flex justify-between items-center">
//                     <div>
//                       <Typography variant="h6" className="opacity-75">Recent Notices</Typography>
//                       <Typography variant="h4">{dashboardData.recentNotices}</Typography>
//                     </div>
...
//                 <Typography variant="h6" className="mb-4 text-gray-700">Students by Floor</Typography>
//                 <BarChart
//                   xAxis={[{ scaleType: 'band', data: ['1st', '2nd', '3rd', '4th', '5th', '6th'] }]}
//                   series={[{ data: dashboardData.floorDistribution }]}
//                   height={300}
//                   colors={['#3b82f6']}
//                 />
//               </Paper>
...
//               <Paper elevation={3} className="p-4">
//                 <Typography variant="h6" className="mb-4 text-gray-700">Department Distribution</Typography>
...
//               <Paper elevation={3} className="p-4">
//                 <Typography variant="h6" className="mb-4 text-gray-700">Monthly Admissions</Typography>
//                 <LineChart
//                   xAxis={[{ data: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'] }]}
//                   series={[{ data: dashboardData.monthlyAdmissions }]}
//                   height={300}
//                   colors={['#10b981']}
//                 />
//               </Paper>
...
//             {/* Recent Activity */}
//             <div className="mt-8">
//               <Typography variant="h6" className="mb-4 text-gray-700">Recent Activity</Typography>
//               <div className="space-y-4">
//                 {[1, 2, 3].map((item) => (
//                   <div key={item} className="p-4 bg-white rounded-lg shadow-sm border border-gray-100">
...
//                         <p className="text-sm text-gray-500">John Doe from CSE department has been assigned to room 305</p>
  ...
  useEffect(() => {
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const seatsResponse = await axios.get("http://localhost:5000/seats");
        ...
        // Fetch alumni data
        const alumniResponse = await axios.get("http://localhost:5000/alumni");
        setAlumniCount(alumniResponse.data.length);

        // Fetch expired seats
        const expiredResponse = await axios.get(
          "http://localhost:5000/expired"
        );
